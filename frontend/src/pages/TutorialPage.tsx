    ...
    <div className="tutorial">
      ...
      <section className="panel tutorial-card">
        ...
        <ul className="tutorial-list">
          <li>
            <b>實體（body）</b>：開盤價與收盤價之間的長方形區塊。實體越長，代表這段時間漲跌幅度越大、多空力道越明確；實體很短甚至變成一條線（十字線），代表多空拉鋸、方向不明確，常出現在轉折點附近。
          </li>
          <li>
      ...
      <section className="panel tutorial-card">
        ...
        <p>
          技術面（K 線、KD 這些）是看「價格和成交量畫出來的圖形」在找進出場<b>時機</b>；基本面則是回頭看「這家公司到底賺不賺錢、值不值得長期持有」，兩者角度不同，常常互補使用。
        </p>
        ...
        <ul className="tutorial-list">
          <li><b>EPS（每股盈餘）</b>：公司幫每一股股票賺了多少錢，是最基本的獲利指標。</li>
          <li><b>ROE（股東權益報酬率）</b>：用股東的錢賺錢的效率，長期穩定的高 ROE 通常代表體質好。</li>
          <li><b>毛利率 / 營益率 / 淨利率</b>：分別看「產品本身賺不賺錢」「本業經營效率」「最終真正落袋的比例」。</li>
        </ul>

        <h4 className="tutorial-subheading">評價指標（股價貴不貴）</h4>
        <ul className="tutorial-list">
          <li><b>本益比（PE）</b>：股價 ÷ EPS，數字越高代表市場願意付出越多倍數買這家公司的獲利。</li>
          <li><b>股價淨值比（PB）</b>：股價 ÷ 每股淨值，常用來評估銀行股、資產型公司。</li>
          <li><b>殖利率</b>：現金股利 ÷ 股價，越高代表相對股價能拿到的配息報酬率越高。</li>
        </ul>

        <h4 className="tutorial-subheading">營運趨勢</h4>
        <ul className="tutorial-list">
          <li>月營收<b>年增率（YoY）</b>、<b>月增率（MoM）</b>：公司生意是在成長還是衰退。</li>
          <li>財報季的季增 / 年增比較：確認獲利趨勢是不是持續的，而不是單一季的曇花一現。</li>
        </ul>

        <h4 className="tutorial-subheading">體質與風險</h4>
        <ul className="tutorial-list">
          <li><b>負債比、流動比率</b>：公司財務結構穩不穩、短期還債能力夠不夠。</li>
          <li><b>現金流量表</b>：帳上的獲利有沒有真的變成現金，而不是紙上富貴。</li>
        </ul>
