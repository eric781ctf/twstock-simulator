    ...
    <>
      <section className="panel tutorial-card">
        ...
        <ol className="tutorial-list">
          <li>用當天收盤的全市場資料，替每一檔上市普通股（不含 ETF、ETN、特別股、TDR）算出一組特徵（技術指標 + 估值）。</li>
      ...
      <section className="panel tutorial-card">
        ...
        <p>
          真正難的地方不是「抓得到美股資料」，是<strong>把它變成每一檔股票各自不同的數字</strong>。
          這個系統每天做的是「在一千多檔裡挑前 10 名」，而「昨晚費半漲 3%」對全市場是同一個值——
          它不會改變任何一檔的相對名次。所以美股資訊要經過三層映射才有用：族群指數依產業對應
          （半導體看費半、電子看那斯達克、傳產看道瓊）、ADR 只屬於那四檔有 ADR 的公司、
          以及每檔股票自己的<strong>跳空敏感度</strong>——同樣是半導體，有的費半漲 3% 它就跳空 2.5%，
          有的只跳 0.8%。
        </p>
        <p className="order-hint">
        ...
        <div className="tutorial-grid">
          ...
          <div>
            ...
            <p>
              ...
              相鄰不代表它們比「01 水泥」接近。另有一欄「未分類」，給產業別還沒同步到的新上市股票——
              「不屬於任何已知產業」本身就是一個類別，全 0 會跟「剛好都不是」混在一起。
            </p>
          </div>
          <div>
